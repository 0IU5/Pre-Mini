    ...
    <div class="min-h-screen justify-center mx-auto max-w-5xl pt-12">
        ...
        <form action="{{ route('guru.update', $guru->id_guru) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama" name="nama" class="w-full p-2 rounded border border-gray-300 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" value="{{ old('nama') ?? $guru->nama }}">
                @error('nama')
            ...
            <div class="mb-4">
                ...
                <input type="number" id="umur" name="umur" class="w-full p-2 rounded border border-gray-300 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" value="{{ old('umur') ?? $guru->umur }}">
                @error('umur')
                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
            @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="pendidikan_terakhir" name="pendidikan_terakhir" class="w-full p-2 rounded border border-gray-300 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" value="{{ old('pendidikan_terakhir') ?? $guru->pendidikan_terakhir }}">
