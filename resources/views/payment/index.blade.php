    ...
    <div class="min-h-screen mx-auto max-w-5xl pt-12">
        ...
        <div class="flex justify-end">
            <form method="GET" action="{{ route('payment.index') }}">
                <input type="text" name="search" placeholder="Cari Nama" value="{{ $search ?? '' }}" class="px-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
